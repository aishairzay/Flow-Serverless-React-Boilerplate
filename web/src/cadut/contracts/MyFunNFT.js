...
/**
* Method to generate cadence code for MyFunNFT contract
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
*/
export const MyFunNFTTemplate = async (addressMap = {}) => {
  ...
  reportMissingImports(CODE, fullMap, `MyFunNFT =>`)
...
/**
* Deploys MyFunNFT transaction to the network
* @param {Object.<string, string>} addressMap - contract name as a key and address where it's deployed as value
* @param Array<*> args - list of arguments
* param Array<string> - list of signers
*/
export const  deployMyFunNFT = async (props) => {
  const { addressMap = {} } = props;
  const code = await MyFunNFTTemplate(addressMap);
  const name = "MyFunNFT"
